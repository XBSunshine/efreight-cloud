...
public class SeTrailerPrint implements Serializable{/**
	 * 
	 */
    ...
    private String Input071;
    private String Input072;
    private String Input073;
    private String Input074;
    private String Input075;
    private String Input076;
    private String Input077;
    private String Input078;
    private String Input079;
    private String Input080;
