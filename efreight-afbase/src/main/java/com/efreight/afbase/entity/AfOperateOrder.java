...
@TableName("af_order")
public class AfOperateOrder implements Serializable {
...
//    private String inboundFileUrl;
     ...
     * 主货单单位
     */
    private String mainOrderUnit;
    /**
     * 提货车牌号
     */
    private String pickUpTruckNumber;
    /**
     * 提货司机
     */
     ...
     * 提货司机联系方式
     */
    private String pickUpDriverTel;
    /**
     * 入区驾驶证号
     */
    private String outfieldDeliveryDrieverLicense;
    /**
     * 入区司机联系方式
     */
    private String outfieldDeliveryDriverTel;
    /**
     * 预计送达时间(入区预约时间）
     */
    private LocalDateTime outfieldDeliveryArriveTime;
    /**
     * 搬运公司
     */
