...
public interface CssIncomeInvoiceMapper extends BaseMapper<CssIncomeInvoice> {
	@Select({"<script>",
		...
		" if(a.debit_note_id=null,d.writeoff_complete,c.writeoff_complete) AS business_writeoff_complete,",
		"IFNULL(c.debit_note_num,d.statement_num) AS business_num ,IFNULL(c.row_uuid,d.row_uuid) AS business_row_uuid,",
		"b.invoice_detail_id,b.invoice_title,b.invoice_date,b.invoice_num,b.invoice_type,b.amount,b.currency,b.amount_writeoff,(IFNULL(b.amount,0)-IFNULL(b.amount_writeoff,0)) AS amount_writeoff_no",
        ...
        " AND a.invoice_status=1 and ((c.debit_note_id is not null and c.writeoff_complete IS NULL) or (d.statement_id is not null and d.writeoff_complete IS NULL))",
        "</when>",
