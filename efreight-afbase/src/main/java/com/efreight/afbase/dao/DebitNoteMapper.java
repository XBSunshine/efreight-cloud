...
public interface DebitNoteMapper extends BaseMapper<DebitNote> {
    ...
    @Select({"<script>",
            ...
            "d.writeoff_complete AS statement_writeoff_complete,",
            ...
            " or ((a.statement_id is NULL and a.writeoff_complete=1) or (a.statement_id is not NULL and d.writeoff_complete=1))",
            "</when>",
            "<when test='bean.billStatus4==\"部分核销\"'>",
            " or ((a.statement_id is NULL and a.writeoff_complete=0) or (a.statement_id is not NULL and d.writeoff_complete=0))",
            "</when>",
            
            "<when test='bean.billStatus5==\"开票完毕\"'>",
            " or ((m.invoice_status = 1 AND a.statement_id is NULL and a.writeoff_complete IS NULL) or (m1.invoice_status = 1 AND a.statement_id is not NULL and d.writeoff_complete IS NULL))",
            "</when>",
